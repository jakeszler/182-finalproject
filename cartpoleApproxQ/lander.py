...
# 			accept_prob = math.exp(-(abs(reward - bestReward) / self.temp))
# 			print("temp", self.temp, "reward diff", reward - bestReward, "accept_prob", accept_prob)
...
# 			self.temps.append(copy.copy(self.temp))
# 			self.temp *= 0.99
# 			self.gammas.append(copy.copy(self.gamma))
# 			self.gamma *= 0.995
...
# agent = simulatedAnnealingAgent("CartPole-v0")
# agent.learn(1000, 0)
# agent.plot()
